# Retirar version publicada

[Indice](README.md) | [Contratos de datos](contratos.md)

`POST /api/v1/procedure-versions/{version_id}/retire`
...
Cambia a retired: reader y busqueda dejan de verla. No borra filas ni archivos. No puede volver a publicarse por este endpoint; preparar otra version.

## Acceso

owner o reviewer; estado published.
...
procedure_versions, audit_events.
