...
`POST /api/v1/learning-sessions/{session_id}/clarifications`
...
Registra una pregunta pendiente. Dentro de la organizacion un reviewer puede plantearla aunque no sea autor de la sesion.

## Acceso

owner, author o reviewer; sesion capturing.
...
```json
{
  "question": "Quien debe aprobar esta cotizacion?"
}
```

## Respuesta

Exito: **201**. `ClarificationResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.
