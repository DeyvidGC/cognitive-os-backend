...
`GET /api/v1/learning-sessions/{session_id}/clarifications`
...
Devuelve preguntas y respuestas de la sesion por fecha; sin paginacion.
...
Exito: **200**. `lista de ClarificationResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.
