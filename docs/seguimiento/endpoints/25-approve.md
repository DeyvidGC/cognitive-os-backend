...
`POST /api/v1/procedure-versions/{version_id}/approve`
...
Repite las validaciones de contenido y registra reviewer_id/approved_at. No publica. Por ahora owner puede aprobar contenido propio.

## Acceso

owner o reviewer; estado in_review.
