# Indexar o reintentar indice

Actualizado: 2026-09-16.

`POST /api/v1/recordings/{recording_id}/index`

Solo escritor; informe aprobado. Retorna Job 202 idempotente por grabacion/revision/modelo. Si failed reinicia intentos. Necesita worker index_recording y OpenAI para generar embeddings; no bloquea informe/reproduccion si falla.
