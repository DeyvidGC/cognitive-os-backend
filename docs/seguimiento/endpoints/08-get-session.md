...
Busca el ID dentro de la organizacion autorizada; un ID ajeno o inexistente responde 404.
...
Exito: **200**. `SessionResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.
