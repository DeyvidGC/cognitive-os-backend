...
try {
    ...
    & "$PgBin/psql.exe" -X -v ON_ERROR_STOP=1 -h 127.0.0.1 -p $testPort -U postgres -d cognitive -f migrations/001_initial.sql -f migrations/002_pgvector.sql -f migrations/004_local_auth.sql -f migrations/005_recordings.sql -f migrations/006_interactive_learning.sql -f migrations/007_recording_vectors.sql -f migrations/008_job_progress.sql -f migrations/009_periodic_learning.sql -f migrations/010_realtime_voice.sql -f migrations/011_knowledge_consolidation.sql -f migrations/012_knowledge_gaps.sql -f migrations/013_chat_queries.sql -f migrations/014_policy_analyzer.sql -f migrations/015_change_proposals.sql -f migrations/016_platform_staff.sql -f migrations/017_policy_retire.sql -f migrations/018_change_proposal_kinds.sql
