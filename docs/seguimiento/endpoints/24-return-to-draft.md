...
`POST /api/v1/procedure-versions/{version_id}/return`
...
Vuelve a draft para permitir correcciones. No sirve para reabrir versiones approved, published o retired.
