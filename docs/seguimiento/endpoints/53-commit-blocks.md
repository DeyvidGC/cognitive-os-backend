# Confirmar bloques reanudables

Actualizado: 2026-09-16.

`POST /api/v1/recordings/{recording_id}/commit-blocks`

Sin body; escritor. Requiere hash en reserva y todos los bloques con tamano esperado. Hace commit y congela snapshot; idempotente. SHA-256 integral se verifica en worker, no solamente con el manifiesto.
