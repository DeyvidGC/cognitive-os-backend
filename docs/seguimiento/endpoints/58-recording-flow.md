...
`GET /api/v1/recordings/{recording_id}/flow`

Retorna schema_version:1, kind:sequence, nodes (id/type/position/data), edges (id/source/target), title, revision, review_status, uncertainties. Los pasos referencian frames con timestamp_ms y text_sources. No inventa ramas condicionales.
