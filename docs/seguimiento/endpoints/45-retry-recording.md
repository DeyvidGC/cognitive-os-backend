# Reintentar analisis fallido

Actualizado: 2026-09-16.

`POST /api/v1/recordings/{recording_id}/retry`

Solo escritor y trabajo analyze_recording failed. Reinicia intentos, marca queued/processing y retorna Job 202. No es reintento del indice vectorial ni regeneracion de informe aprobado.
