# Confirmar subida completa

Actualizado: 2026-09-16.

`POST /api/v1/recordings/{recording_id}/complete`

Sin body. Verifica tamano/tipo del blob y crea snapshot condicionado a ETag. Retorna Recording uploaded; repetir no vuelve a congelar. 409 por metadata distinta; 503 almacenamiento no configurado/inaccesible.
