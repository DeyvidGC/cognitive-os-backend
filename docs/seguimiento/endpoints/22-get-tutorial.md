...
`GET /api/v1/procedure-versions/{version_id}/tutorial`
...
Devuelve contenido Markdown, no una pagina HTML renderizada. El frontend debe renderizarlo sin ejecutar HTML no confiable. Si no existe responde 404.
