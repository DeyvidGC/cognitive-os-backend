...
`POST /api/v1/recordings/{recording_id}/report/regenerate`

Body {revision}. Solo escritor; informe no aprobado y preguntas resueltas. Retorna Job 202; repeticiones mientras esta pendiente reutilizan trabajo. Nuevo analisis incluye notas/transcripcion/aclaraciones, conserva historia y necesita otra revision humana.
