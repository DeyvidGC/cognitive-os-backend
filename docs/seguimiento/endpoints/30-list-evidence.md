...
`GET /api/v1/learning-sessions/{session_id}/evidence`
...
Lista metadatos de todas las evidencias de la sesion por fecha; sin paginacion. No expone storage_key.
...
Exito: **200**. `lista de EvidenceResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.

## Persistencia y limites

learning_sessions, evidence.
