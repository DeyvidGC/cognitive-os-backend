...
Guarda la identidad del proceso con titulo y alcance. Aun no crea versiones ni pasos.
...
```json
{
  ...
  "scope": "Cotizaciones del equipo comercial"
}
```

## Respuesta

Exito: **201**. `ProcedureResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.
