...
`GET /api/v1/recordings/{recording_id}/report/history`

Query limit=20 (1..100), offset>=0. Devuelve revisiones archivadas con snapshot y created_at, mas reciente primero. La revision actual se obtiene en /report.
