...
`GET /api/v1/learning-sessions/{session_id}/agent/messages`

Query limit=50 (1..100), offset>=0. Orden cronologico. Devuelve id, message_id, text, reply, status, created_at. No almacena ni expone imagenes originales del socket.
