...
`GET /api/v1/procedure-versions/{version_id}`
...
Busca version por UUID. Para reader una version no publicada responde 404, igual que una version ajena.

## Acceso

Cualquier miembro; reader solo accede si esta published.
