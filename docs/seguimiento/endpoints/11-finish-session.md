# Cerrar captura y crear trabajo

[Indice](README.md) | [Contratos de datos](contratos.md)

`POST /api/v1/learning-sessions/{session_id}/finish`
...
Exito: **202**. `JobResponse`. Campos y tipos en [contratos](contratos.md). Las listas son arrays JSON sin envoltorio total/items.

## Persistencia y limites

learning_sessions, session_events, evidence, clarifications, jobs.
