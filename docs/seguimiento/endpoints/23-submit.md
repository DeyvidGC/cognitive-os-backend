...
`POST /api/v1/procedure-versions/{version_id}/submit`
...
Requiere tutorial Markdown, al menos un paso, todos confirmed y posiciones consecutivas desde 1. Pasos observed/inferred necesitan evidencia. Cambia a in_review.

## Acceso

owner o author; estado draft.
...
procedure_versions, steps, step_evidence, tutorials, audit_events.
