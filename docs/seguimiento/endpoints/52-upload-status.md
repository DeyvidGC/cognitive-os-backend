...
`GET /api/v1/recordings/{recording_id}/upload-status`

Escritor. Mientras uploading devuelve complete:false, block_size_bytes=4194304, content_sha256 y blocks con index/id/size_bytes/uploaded. Despues de completar devuelve complete:true. El hash permite comprobar el archivo seleccionado antes de reanudar.
